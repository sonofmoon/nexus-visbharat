...
class Config:
    ...
    GMAIL_PUBSUB_TOPIC = os.environ.get('GMAIL_PUBSUB_TOPIC', '').strip()
    GMAIL_PUBSUB_AUDIENCE = os.environ.get('GMAIL_PUBSUB_AUDIENCE', '').strip()
    GMAIL_PUBSUB_SERVICE_ACCOUNT = os.environ.get('GMAIL_PUBSUB_SERVICE_ACCOUNT', '').strip().lower()
    GMAIL_PUBSUB_SHARED_TOKEN = os.environ.get('GMAIL_PUBSUB_SHARED_TOKEN', '')
    GMAIL_SECRET_PROVIDER_ENABLED = _as_bool('GMAIL_SECRET_PROVIDER_ENABLED', False)
    GMAIL_SECRET_PROVIDER_PREFIX = os.environ.get('GMAIL_SECRET_PROVIDER_PREFIX', 'visbharat/gmail').strip()
    GMAIL_WATCH_LABEL_IDS = _load_json_list('GMAIL_WATCH_LABEL_IDS_JSON', ['INBOX'])
    GMAIL_WATCH_RENEWAL_INTERVAL_SECONDS = int(os.environ.get('GMAIL_WATCH_RENEWAL_INTERVAL_SECONDS', '86400'))
    GMAIL_API_TIMEOUT_SECONDS = int(os.environ.get('GMAIL_API_TIMEOUT_SECONDS', '15'))
    GMAIL_HISTORY_PAGE_SIZE = int(os.environ.get('GMAIL_HISTORY_PAGE_SIZE', '100'))
    GMAIL_MAX_MESSAGES_PER_PUSH = int(os.environ.get('GMAIL_MAX_MESSAGES_PER_PUSH', '50'))
    GMAIL_SEND_CONFIRMATIONS = _as_bool('GMAIL_SEND_CONFIRMATIONS', True)
